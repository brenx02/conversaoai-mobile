...
const INSIGHTS = [
  {
    icon: "🔥",
    title: "Hook nos 3 primeiros segundos",
    text: "70% decide parar no 1º segundo. Ataque a dor imediatamente.",
  },
  {
    icon: "🎯",
    title: "Especificidade converte mais",
    text: '"Perca 7kg em 21 dias" converte 3x mais que "Emagreça rápido".',
  },
  {
    icon: "📊",
    title: "CTR < 1%? Mude o criativo",
    text: "O problema não é a audiência. Mude o hook antes da segmentação.",
  },
];
  ...
  async function loadData() {
    try {
      ...
      if (histRes.status === "fulfilled")
        setRecentItems(histRes.value.data?.data || []);
          ...
          <View style={styles.creditsCard}>
            ...
            >
              ...
              <Text style={styles.creditsValue}>
                {usage?.creditsUsed || 0} /{" "}
                {usage?.creditsLimit || user?.aiCreditsLimit || 10}
              </Text>
            </View>
              ...
              <View
                style={[
                  styles.progressFill,
                  {
                    ...
                    backgroundColor:
                      creditsPercent > 80 ? COLORS.red : COLORS.accent2,
                  },
                ]}
              />
            </View>
