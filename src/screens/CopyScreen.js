    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <Text style={styles.sub}>
          Escolha o formato e gere copy de alta conversão
        </Text>
        ...
        >
          {COPY_TYPES.map((t) => (
            <TouchableOpacity
              ...
              style={[
                styles.typeCard,
                activeType === t.id && styles.typeCardActive,
              ]}
              ...
              <View style={{ flexDirection: "row", gap: 8 }}>
                {TONES.map((t, i) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.toneBtn,
                      toneIdx === i && styles.toneBtnActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.toneTxt,
                        toneIdx === i && styles.toneTxtActive,
                      ]}
                    >
                      {t}
                    </Text>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <Text style={styles.genBtnText}>Gerar Copy com IA</Text>
              </>
            )}
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.toolsGrid}>
          {OTHER_TOOLS.map((t) => (
            ...
            >
              <Text style={{ fontSize: 20 }}>{t.icon}</Text>
              <Text style={[styles.toolBtnLabel, { color: t.color }]}>
                {t.label}
              </Text>
            </TouchableOpacity>
          ))}
