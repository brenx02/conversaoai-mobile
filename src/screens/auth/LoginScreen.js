...
export default function LoginScreen({ navigation }) {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      if (err.error === 'TOO_MANY_LOGIN_ATTEMPTS' || err.error === 'ACCOUNT_LOCKED') {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.subtitle}>Bem-vindo de volta! ✌️</Text>
...
const styles = StyleSheet.create({
  ...
  logoIcon:          { width: 60, height: 60, borderRadius: 16, backgroundColor: COLORS.accent, justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  logoText:          { fontSize: 26, fontFamily: FONTS.heading, color: COLORS.text, letterSpacing: -0.5 },
  logoSub:           { fontSize: 11, color: COLORS.text3, letterSpacing: 1.5, textTransform: 'uppercase', marginTop: 3 },
  ...
  errorBanner:       { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.redBg, borderRadius: RADIUS.md, padding: SPACING.md, marginBottom: SPACING.md, borderWidth: 1, borderColor: COLORS.red + '44' },
  ...
  inputWrap:         { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.surface2, borderRadius: RADIUS.md, borderWidth: 1, borderColor: COLORS.border2, paddingHorizontal: 12 },
  inputError:        { borderColor: COLORS.red },
  inputIcon:         { marginRight: 8 },
  input:             { flex: 1, height: 48, color: COLORS.text, fontSize: 14, fontFamily: FONTS.body },
  eyeBtn:            { padding: 8 },
  fieldError:        { fontSize: 11, color: COLORS.red, marginTop: 2 },
  forgotBtn:         { alignSelf: 'flex-end' },
  forgotText:        { fontSize: 12, color: COLORS.accent2 },
  primaryBtn:        { backgroundColor: COLORS.accent, borderRadius: RADIUS.md, height: 52, justifyContent: 'center', alignItems: 'center', marginTop: SPACING.sm },
  primaryBtnDisabled:{ opacity: 0.6 },
  primaryBtnText:    { fontSize: 15, fontFamily: FONTS.heading, color: '#fff', letterSpacing: 0.3 },
  ...
  socialBtn:         { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: COLORS.surface, borderRadius: RADIUS.md, height: 50, borderWidth: 1, borderColor: COLORS.border2 },
