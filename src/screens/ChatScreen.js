    ...
    <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.75}>
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.tags}>
          {item.tags.map(tag => (
            <View key={tag} style={[styles.tag, { backgroundColor: item.color + '18' }]}>
...
const styles = StyleSheet.create({
  ...
  cardEmoji:   { width: 48, height: 48, borderRadius: RADIUS.md, justifyContent: 'center', alignItems: 'center', flexShrink: 0 },
  cardContent: { flex: 1 },
  ...
  cardDesc:    { fontSize: 12, color: COLORS.text2, marginBottom: 7, lineHeight: 17 },
  tags:        { flexDirection: 'row', flexWrap: 'wrap', gap: 4 },
  tag:         { paddingHorizontal: 7, paddingVertical: 2, borderRadius: RADIUS.full },
  tagText:     { fontSize: 10, fontFamily: FONTS.medium },
  badge:       { backgroundColor: COLORS.pink + '22', paddingHorizontal: 7, paddingVertical: 2, borderRadius: RADIUS.full },
